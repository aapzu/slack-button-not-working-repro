# slack-button-not-working-repro

## How to reproduce
1. Clone this repo
2. Run `slack run`
3. Install trigger, if asked
4. Copy the trigger link
5. Open the Slack workspace where the app is installed
6. Go to a channel and invite the bot there
7. Paste the trigger link in the channel
8. Start the workflow, you should see a message with a button
9. Click the button
